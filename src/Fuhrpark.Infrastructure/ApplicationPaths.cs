...
public static class ApplicationPaths
{
    ...
    public const string ProductFolder = "Fuhrparkmanagement";

    /// <summary>Maschinenweite Konfiguration: C:\ProgramData\LSP Virtual Services\Fuhrparkmanagement.</summary>
    public static string MachineData => Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData),
        CompanyFolder, ProductFolder);

    /// <summary>Benutzerbezogene Einstellungen: %LocalAppData%\LSP Virtual Services\Fuhrparkmanagement.</summary>
