...
public sealed partial class SetupViewModel : ObservableObject
{
    ...
    private void RunSystemCheck()
    {
        ...
        Checks.Add(new SetupCheckResult(isAdministrator,
            ...
            isAdministrator
                ? null
                : "Bitte rechts auf FuhrparkServerSetup.exe klicken und „Als Administrator ausführen“ wählen."));
    ...
    private async Task RunFinalCheckAsync()
    {
        ...
        var db2 = scope.ServiceProvider.GetRequiredService<FuhrparkDbContext>();
    ...
    private static async Task UpsertSettingAsync(FuhrparkDbContext db, string key, string? value)
    {
