...
{
    /// <summary>Pfad zum Update-Installer (FuhrparkManager-Update-x.x.x.exe).</summary>
    ...
    public string MainExecutable => Path.Combine(ApplicationDirectory, "FuhrparkManager.exe");
