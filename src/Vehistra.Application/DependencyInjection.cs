...
using Vehistra.Application.Security;
using Vehistra.Application.Services;
using Microsoft.Extensions.DependencyInjection;

namespace Vehistra.Application;

/// <summary>Registriert alle Anwendungsdienste im DI-Container.</summary>
public static class DependencyInjection
{
    public static IServiceCollection AddVehistraApplication(this IServiceCollection services)
    {
