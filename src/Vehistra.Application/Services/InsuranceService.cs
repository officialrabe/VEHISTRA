...
public sealed class InsuranceService : IInsuranceService
{
    ...
    public InsuranceService(IVehistraDbContext db, ICurrentUserService currentUser)
    {
        _db = db;
...
public sealed class VehicleKeyService : IVehicleKeyService
{
    ...
    public VehicleKeyService(IVehistraDbContext db, ICurrentUserService currentUser)
    {
        _db = db;
        _currentUser = currentUser;
    }
