...
namespace Vehistra.Client;

/// <summary>
/// Einstiegspunkt der Vehistra. Baut den DI-Container auf, prueft die
...
public partial class App : System.Windows.Application
{
    ...
    protected override async void OnStartup(StartupEventArgs e)
    {
        ...
        catch (Exception exception)
        {
            ...
            MessageBox.Show(
                ...
                "Vehistra", MessageBoxButton.OK, MessageBoxImage.Error);
    ...
    private static void ConfigureLogging()
    {
        ...
        Log.Information("Vehistra wird gestartet ({Version}).",
