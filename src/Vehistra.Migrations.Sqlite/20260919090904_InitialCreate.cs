        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumDatabaseVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComputerName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    Action = table.Column<int>(type: "INTEGER", nullable: false),
                    EntityName = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    EntityId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    EntityDisplay = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    ...
                    AdditionalInfo = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
                    ApplicationVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TriggeredByUserName = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    ComputerName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedByUserName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ModifiedByUserId = table.Column<int>(type: "INTEGER", nullable: true),
                    ModifiedByUserName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastMigration = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    AppliedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    AppliedByComputer = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    AppliedByUserName = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    ApplicationVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    MinimumSupportedApplicationVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeaderText = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    FooterText = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    NoticeText = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PersonnelNumber = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    ...
                    Mobile = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    LockKey = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    IsLocked = table.Column<bool>(type: "INTEGER", nullable: false),
                    LockedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    LockedByComputer = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    LockedByUserName = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    LockedByProcess = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "INTEGER", nullable: true),
                    UserName = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    OldApplicationVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    NewApplicationVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    OldDatabaseVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    NewDatabaseVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    Outcome = table.Column<int>(type: "INTEGER", nullable: false),
                    BackupPath = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    ErrorMessage = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastLoginComputer = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SortOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsSystemStatus = table.Column<bool>(type: "INTEGER", nullable: false),
                    CountsAsOperational = table.Column<bool>(type: "INTEGER", nullable: false),
                    CountsAsAvailable = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "INTEGER", nullable: true),
                    CreatedByUserName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    Email = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    ContactPerson = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    Comment = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsArchived = table.Column<bool>(type: "INTEGER", nullable: false),
                    ArchivedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    InternalNumber = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    LicensePlate = table.Column<string>(type: "TEXT", maxLength: 16, nullable: true),
                    Vin = table.Column<string>(type: "TEXT", maxLength: 24, nullable: true),
                    ...
                    Variant = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    ...
                    CurrentMileageAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Hsn = table.Column<string>(type: "TEXT", maxLength: 8, nullable: true),
                    Tsn = table.Column<string>(type: "TEXT", maxLength: 8, nullable: true),
                    PurchaseDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    PurchasePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    IsLeased = table.Column<bool>(type: "INTEGER", nullable: false),
                    LeasingCompany = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    LeasingContractNumber = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    LeasingStart = table.Column<DateTime>(type: "TEXT", nullable: true),
                    LeasingEnd = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Comment = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    VehicleStatusId = table.Column<int>(type: "INTEGER", nullable: false),
                    CurrentDriverId = table.Column<int>(type: "INTEGER", nullable: true),
                    NextInspectionDue = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationOffice = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    Comment = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    IsSeasonPlate = table.Column<bool>(type: "INTEGER", nullable: false),
                    SeasonFrom = table.Column<string>(type: "TEXT", maxLength: 8, nullable: true),
                    SeasonTo = table.Column<string>(type: "TEXT", maxLength: 8, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "INTEGER", nullable: true),
                    CreatedByUserName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarnDaysBefore = table.Column<int>(type: "INTEGER", nullable: false),
                    WarnKilometersBefore = table.Column<int>(type: "INTEGER", nullable: false),
                    VehicleId = table.Column<int>(type: "INTEGER", nullable: true),
                    VehicleCategoryId = table.Column<int>(type: "INTEGER", nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsSystemRule = table.Column<bool>(type: "INTEGER", nullable: false),
                    SortOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "INTEGER", nullable: true),
                    CreatedByUserName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecordedByUserName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeduplicationKey = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedByUserId = table.Column<int>(type: "INTEGER", nullable: true),
                    AssignedByUserName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    Comment = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolicyNumber = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    VehicleId = table.Column<int>(type: "INTEGER", nullable: false),
                    KeyNumber = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    Count = table.Column<int>(type: "INTEGER", nullable: false),
                    StorageLocation = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    IssuedToDriverId = table.Column<int>(type: "INTEGER", nullable: true),
                    IssuedToName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeregisteredAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    LicensePlate = table.Column<string>(type: "TEXT", maxLength: 16, nullable: true),
                    NewLicensePlate = table.Column<string>(type: "TEXT", maxLength: 16, nullable: true),
                    RegistrationOffice = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReasonText = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    IsDeregistered = table.Column<bool>(type: "INTEGER", nullable: false),
                    DeregisteredAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    LicensePlateRemoved = table.Column<bool>(type: "INTEGER", nullable: false),
                    LastMileage = table.Column<int>(type: "INTEGER", nullable: true),
                    IsSold = table.Column<bool>(type: "INTEGER", nullable: false),
                    SalePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Buyer = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    IsScrapped = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsTotalLoss = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsLeasingReturn = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsSparePartDonor = table.Column<bool>(type: "INTEGER", nullable: false),
                    Comment = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "INTEGER", nullable: true),
                    CreatedByUserName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangedByUserName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    Reason = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    Comment = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationOffice = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    ReservationNumber = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    PinEncrypted = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextEmissionDueDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Result = table.Column<int>(type: "INTEGER", nullable: false),
                    TestCenter = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    Inspector = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    Mileage = table.Column<int>(type: "INTEGER", nullable: true),
                    Cost = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Defects = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    Comment = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProposedDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ...
                    WorkToPerform = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    VehicleHandedOverAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    PlannedCompletionAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CompletedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    PickedUpAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    MileageAtHandover = table.Column<int>(type: "INTEGER", nullable: true),
                    ...
                    InvoiceNumber = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    InvoiceDocumentId = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    AccidentNumber = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    VehicleId = table.Column<int>(type: "INTEGER", nullable: false),
                    DriverId = table.Column<int>(type: "INTEGER", nullable: true),
                    DriverPhone = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    ...
                    Mileage = table.Column<int>(type: "INTEGER", nullable: true),
                    Type = table.Column<int>(type: "INTEGER", nullable: false),
                    TypeOther = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    CourseOfEvents = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
                    ThirdPartyInvolved = table.Column<bool>(type: "INTEGER", nullable: false),
                    PersonalInjury = table.Column<bool>(type: "INTEGER", nullable: false),
                    PoliceInvolved = table.Column<bool>(type: "INTEGER", nullable: false),
                    PoliceStation = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    PoliceFileNumber = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    VehicleDriveable = table.Column<bool>(type: "INTEGER", nullable: false),
                    VehicleInsuranceId = table.Column<int>(type: "INTEGER", nullable: true),
                    OwnInsuranceClaimNumber = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    Comment = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkshopId = table.Column<int>(type: "INTEGER", nullable: true),
                    WorkshopOrderId = table.Column<int>(type: "INTEGER", nullable: true),
                    Cost = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Comment = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    WorkshopOrderId = table.Column<int>(type: "INTEGER", nullable: false),
                    VehicleDocumentId = table.Column<int>(type: "INTEGER", nullable: false),
                    Category = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    AccidentReportId = table.Column<int>(type: "INTEGER", nullable: false),
                    VehicleDocumentId = table.Column<int>(type: "INTEGER", nullable: false),
                    LinkedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    LinkedByUserId = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsuranceNumber = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    VehicleDescription = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    Comment = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "INTEGER", nullable: true),
                    CreatedByUserName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    DamageNumber = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    VehicleId = table.Column<int>(type: "INTEGER", nullable: false),
                    DriverId = table.Column<int>(type: "INTEGER", nullable: true),
                    OccurredAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Mileage = table.Column<int>(type: "INTEGER", nullable: true),
                    ...
                    IsDriveable = table.Column<bool>(type: "INTEGER", nullable: false),
                    RepairRequired = table.Column<bool>(type: "INTEGER", nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    WorkshopId = table.Column<int>(type: "INTEGER", nullable: true),
                    WorkshopOrderId = table.Column<int>(type: "INTEGER", nullable: true),
                    RepairedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ...
                    IsInsuranceCase = table.Column<bool>(type: "INTEGER", nullable: false),
                    InsuranceClaimNumber = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    AccidentReportId = table.Column<int>(type: "INTEGER", nullable: true),
                    ClosedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ClosedByUserId = table.Column<int>(type: "INTEGER", nullable: true),
                    Comment = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkshopOrderId = table.Column<int>(type: "INTEGER", nullable: true),
                    AccidentReportId = table.Column<int>(type: "INTEGER", nullable: true),
                    VehicleDocumentId = table.Column<int>(type: "INTEGER", nullable: true),
                    GeneratedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    GeneratedByUserId = table.Column<int>(type: "INTEGER", nullable: true),
                    GeneratedByUserName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    IsBlankForm = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "INTEGER", nullable: true),
                    CreatedByUserName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DamageReportId = table.Column<int>(type: "INTEGER", nullable: true),
                    StandardTaskKey = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    Cost = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Comment = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "INTEGER", nullable: true),
